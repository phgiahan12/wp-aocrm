...
class Acfct_utils
{
	...
	public static function get_span_tags_from_array($keywords)
	{
		$tags = array_map(function ($keyword) {
			return "<span class='highlight' style='display: inline-block; padding: 3px 8px; border-radius: 4px; font-weight: 400; background-color: #efefef; color: #504b4b; margin-right: 4px; margin-bottom: 4px;'>" . esc_html($keyword) . "</span>";
		}, $keywords);
		return implode("", $tags);
	}
