...
class AnimatedLink extends Module_Base {
	...
	public function get_icon() {
		return 'bdt-wi-animated-link bdt-new';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            'link_text', 
             [
                ...
                'dynamic'     => ['active' => true],
                'default'     => __('Animated Link', 'bdthemes-element-pack'),
                'label_block' => true,
            ]
        );
		...
		$this->start_controls_section(
			'section_style_link',
			[
				'label'     => __( 'Animated Link', 'bdthemes-element-pack' ),
	...
	protected function render() {
		...
		<?php elseif ($settings['link_style'] == 'herse') : ?>
			<a <?php echo($this->get_render_attribute_string('link-wrap')); ?>>
				<span><?php echo esc_html($settings['link_text']); ?></span>
				<svg class="bdt-link__graphic bdt-link__graphic--stroke bdt-link__graphic--arc" width="100%" height="18" viewBox="0 0 59 18"><path d="M.945.149C12.3 16.142 43.573 22.572 58.785 10.842" pathLength="1"/></svg>
			</a>
