...
class Animated_Card extends Module_Base {
	...
	public function get_icon() {
		return 'bdt-wi-animated-card bdt-new';
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __('Animated Card', 'bdthemes-element-pack'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => __('Animated Card Title', 'bdthemes-element-pack'),
		...
		$this->add_control(
			'readmore',
			[
				'label'     => __('Show Read More', 'bdthemes-element-pack'),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
			]
		);
	...
	public function render_animated_image() {
		...
		<div class="bdt-ep-animated-card-img-wrap">
			<img class="bdt-ep-animated-card-img" src="<?php echo esc_url($thumb_url); ?>" alt="<?php echo esc_html($settings['title_text']); ?>">
		</div>
		<?php
	}
		...
		<?php if ('yes' == $settings['show_sub_title']) : ?>
			<?php if ($settings['sub_title_text']) : ?>
				<<?php echo Utils::get_valid_html_tag($settings['sub_title_size']); ?>
				 <?php echo $this->get_render_attribute_string('animated_sub_title'); ?>>
		...
		<?php if ('yes' == $settings['show_title']) : ?>
			<?php if ($settings['title_text']) : ?>
				<<?php echo Utils::get_valid_html_tag($settings['title_size']); ?>
				 <?php echo $this->get_render_attribute_string('animated-title'); ?>>
