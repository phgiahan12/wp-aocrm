    ...
    public function render_loop_item() {
        ...
        ?>
            <div id="bdt-testimonial-grid-<?php echo $this->get_id(); ?>" <?php echo $this->get_render_attribute_string('testimonial-grid'); ?>>
                ...
                $this->add_render_attribute('testimonial-grid-item', 'class', 'bdt-width-1-' . esc_attr($columns_mobile));
                $this->add_render_attribute('testimonial-grid-item', 'class', 'bdt-width-1-' . esc_attr($columns_tablet) . '@s');
                $this->add_render_attribute('testimonial-grid-item', 'class', 'bdt-width-1-' . esc_attr($columns) . '@m');
