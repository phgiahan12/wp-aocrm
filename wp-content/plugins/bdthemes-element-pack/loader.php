...
class Element_Pack_Loader {
	...
	public function register_site_scripts() {
		...
		if (element_pack_is_widget_enabled('chart')) {
			wp_register_script('chart', BDTEP_ASSETS_URL . 'vendor/js/chart.min.js', ['jquery'], '2.7.3', true);
		}
		...
		if (element_pack_is_widget_enabled('scrollnav') or element_pack_is_widget_enabled('price-table') or element_pack_is_widget_enabled('marker') or element_pack_is_widget_enabled('logo-grid') or element_pack_is_widget_enabled('logo-carousel') or element_pack_is_widget_enabled('iconnav') or element_pack_is_widget_enabled('helpdesk')) {
