...
class ElementPack_Admin_Settings {
    ...
    function __construct() {
        ...
        if($el_use_mini_cart !== false && $ep_3rdPartyOption !== false){
            ...
            if('yes' == $el_use_mini_cart && 'off' !== trim($ep_3rdPartyOption['wc-mini-cart'])){
                ...
                <div class="bdt-width-1-2@m">
                    <div class="bdt-card bdt-card-body ep-tryaddon-bg">
                        ...
                        <p style="max-width: 520px;">
                            <b>Prime Slider, Ultimate Post Kit & Ultimate Store Kit</b> addons for <b>Elementor</b> is the best slider &
                            blogs plugin for WordPress.
                        </p>
                        <a class="bdt-button bdt-btn-blue bdt-margin-small-top bdt-margin-small-right"
                           target="_blank" href="https://bdt.to/ep-ref-ps" bdt-tooltip="It's Free! Download it.">Prime
                            Slider</a>
                        <a class="bdt-button bdt-btn-red bdt-margin-small-top bdt-margin-small-right" target="_blank" rel="" href="https://bdt.to/ep-ref-upk" bdt-tooltip="It's Free! Download it.">Ultimate Post Kit</a>
                        <a class="bdt-button bdt-btn-green bdt-margin-small-top" target="_blank" rel="" href="https://downloads.wordpress.org/plugin/ultimate-store-kit.zip" bdt-tooltip="It's Free! Download it.">Ultimate store Kit</a>
                    </div>
                </div>
            </div>
